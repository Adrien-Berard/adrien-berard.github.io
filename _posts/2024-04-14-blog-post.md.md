...
1. **Dynamics and kinetics of heterochromatin**
    ...
    - Description: 
        ...
        ![Figure 1.1 - Chromatin to Chromosome by Daniel A. Gilchrist](https://adrien-berard.github.io/adrien-berard.github.io/images/ChromatinToChromosome.jpg)
        *Figure 1.1 - Chromatin to Chromosome by Daniel A. Gilchristn*
        ...
        ![Figure 1.2 - Diagram of major discoveries about chromatin by Ramachandran Boopathi](https://adrien-berard.github.io/adrien-berard.github.io/images/Diagram-represent-major-discoveries-in-the-history-of-chromatin-studies-Image-modified.png)
...
2. **Experimental study of swarming behavior of *pseudomonas aeruginosa***
    ...
    **[TO COMPLETE]**
    ...
    - [Link to french report Internship LJP by Adrien Berard 2023](https://adrien-berard.github.io/adrien-berard.github.io/files/RapportStage_LJP2023-6.pdf)
...
3. **Multiparamaters’ evaluation of cardiac dynamic using ultra-fast echocardiography**
    ...
    - [Link to french report Internship Physics for Medicin by Adrien Berard 2022](https://adrien-berard.github.io/adrien-berard.github.io/files/Rapport_de_stage_CPES3_PhysM_BERARD_ADRIEN.pdf)
...
4. **Molecular dynamics simulation of a minimal elastic catalyst model**
   ...
   <source src="https://adrien-berard.github.io/adrien-berard.github.io/images/ovitofilm.mp4" type="video/mp4" />
    </video>
    ...
    *Movie 4.1 - MD Simulation of 20 particles in a periodic box using Langevin equation, Verlet algorithm and NVT ensemble.*
    ...
    ![Alt text](https://adrien-berard.github.io/adrien-berard.github.io/images/CatalystModel.png) 
    *Figure 4.2 - Elastic catalyst model by Olivier Rivoire - graphic realised with InkScape by Adrien Berard.* 
    ![Alt text](https://adrien-berard.github.io/adrien-berard.github.io/images/2potentialDepths.png)
    *Figure 4.3 - Elastic catalyst model by Olivier Rivoire - Kramers escape problem with two wells and its realisation using MD simulations* 
    ...
    - [Link to french report Internship CIRB - Collège de France by Adrien Berard 2021](https://adrien-berard.github.io/adrien-berard.github.io/files/Rapport_de_stage_BERARD_ADRIEN_CPES2CIRB.pdf)
