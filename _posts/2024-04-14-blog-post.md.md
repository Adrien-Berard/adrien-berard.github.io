...
4. **Molecular dynamics simulation of a minimal elastic catalyst model**
    ...
    TO DO:
        - Décrire l'équation de Langevin
        ![Alt text](https://adrien-berard.github.io/website.github.io/images/LangevinEquation.png) *Figure 4.1 - Langevin equation.*

        - Décrire la dynamique moléculaire
        <video src="https://adrien-berard.github.io/website.github.io/images/ovitofilm.mp4" controls title="*Movie 4.1 - Langevin equation*"></video> 

        - Décrire le potentiel de Lennard-Jones
        - décrire le modèle élastique

        ![Alt text](https://adrien-berard.github.io/website.github.io/images/CatalystModel.png) 
        *Figure 4.2 - Elastic catalyst model by Olivier Rivoire - graphic realised with InkScape by Adrien Berard.* 
        ![Alt text](https://adrien-berard.github.io/website.github.io/images/2potentialDepths.png)
